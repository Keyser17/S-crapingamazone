...
function extractFacilities() {
    return __awaiter(this, void 0, void 0, function () {
        var html, $_1, facilities_1, outputPath;
        return __generator(this, function (_a) {
            try {
                ...
                $_1('div.dc6c58be0b span.a5a5a75131').each(function (_, element) {
                    var facility = $_1(element).text().trim();
                    if (facilities_1) {
                        facilities_1.push(facility);
                    }
                });
                // Vérifier si des points forts ont été trouvés
                if (facilities_1.length === 0) {
                    console.log('Aucun point fort trouvé.');
                }
                else {
                    console.log('Points forts extraits :', facilities_1);
                }
                outputPath = './lib/scraper/Booking/Ses_Points-Fort/extracted_facilities.json';
                fs.writeFileSync(outputPath, JSON.stringify({ facilities: facilities_1 }, null, 2), 'utf-8');
