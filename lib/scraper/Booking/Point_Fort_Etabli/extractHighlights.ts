...
async function extractHighlights() {
  try {
    ...
    const highlights = $('div.property-highlights h3:contains("Points forts de l\'établissement")')
      .next('.ph-section')
    ...
    const breakfastInfo = $('div.ph-section h4:contains("Infos concernant le petit-déjeuner")')
      .parent()
      .next('.ph-content')
